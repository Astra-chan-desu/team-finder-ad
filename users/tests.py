...
class SkillAJAXTest(TestCase):
    ...
    def test_add_existing_skill(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertJSONEqual(response.content, {'status': 'ok', 'id': self.skill_python.pk, 'name': 'Python'})
    ...
    def test_remove_skill(self):
        ...
        self.client.login(email='skills@example.com', password='pass123')
        remove_url = reverse('users:skill_remove', kwargs={'pk': self.user.pk, 'skill_id': self.skill_js.pk})
...
class UserListFilterTest(TestCase):
    def setUp(self):
        ...
        self.user2 = User.objects.create_user(
            email='boris@example.com', password='123',
