...
# Тестирование
Здрасьте! Я добавил тестирование! 
```
python manage.py test users projects --verbosity=2
```
...
После заполнения `.env` и настройки базы данных нужно провести миграции:
```
python manage.py migrate
```

А теперь можно запустить сервер разработки:
